...
// amiibo amiibo_icon ftp ftp_icon Add in...
        ...
        qapp->ApplyConfigForElement("main_menu", "ftp_icon", this->ftp); // Sorry theme makers... logo must be visible, but can be moved
        this->Add(this->ftp);
        ...
        qapp->ApplyConfigForElement("main_menu", "amiibo_icon", this->amiibo); // Sorry theme makers... logo must be visible, but can be moved
